      ...
      <main className="min-h-screen bg-[#0f172a] text-white flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12">
          <div className="w-full max-w-sm text-center">
            ...
            <a href="/auth/login" className="inline-block mt-6 text-sm text-orange-400 hover:text-orange-300 transition-colors">
              ← Back to sign in
            </a>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <div className="mt-5 pt-4 border-t border-white/10 text-center">
              <p className="text-xs text-slate-500">
                ...
                <a href="/auth/login" className="text-orange-400 hover:text-orange-300 transition-colors">
                  Sign in →
                </a>
              </p>
            </div>
          ...
          <p className="text-center text-xs text-slate-600 mt-4">
            Free plan includes basic STR status. Upgrade to Standard or Pro for full details.
          </p>
        </div>
      </div>
    </main>
