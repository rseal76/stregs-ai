...
function ResultsContent() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      {/* Address */}
      <p className="text-slate-400 text-sm mb-1">Results for</p>
      <h1 className="text-xl font-semibold text-white mb-4">{address}</h1>

      {/* Jurisdiction */}
      <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-lg px-3 py-1.5 mb-6">
        <span className="text-xs text-blue-400 font-medium">📍 Jurisdiction: {result.jurisdiction}</span>
      </div>
